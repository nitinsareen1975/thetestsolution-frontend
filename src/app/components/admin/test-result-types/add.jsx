...
const { Option } = Select;
class AddTestResultType extends React.Component {
  ...
  handleSubmit = async (data) => {
    ...
    this.props.addTestResultType(data).then(async (response) => {
      ...
      <div>
        <Row gutter={24}>
          <Col xs={24} sm={24} md={12} lg={12} xl={12}>
            <Typography.Title level={4}>Add Result Type</Typography.Title>
          </Col>
