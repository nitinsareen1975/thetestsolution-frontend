...
class EditPricing extends React.Component {
  ...
  async componentDidMount() {
    ...
    let pricing = await this.props.getPricing(this.props.match.params.id);
    this.setState({
      loading: false,
      currency_codes: currency_codes,
      test_types: test_types.status ? test_types.data : [],
      pricing: pricing.status ? pricing.data : {},
      dataLoaded: true
    });
  }
  ...
  handleSubmit = async (data) => {
    ...
    this.props.updatePricing(this.props.match.params.id, data).then(async (response) => {
      ...
      <div>
        <Row gutter={24}>
          <Col xs={24} sm={24} md={12} lg={12} xl={12}>
            <Typography.Title level={4}>Edit Pricing</Typography.Title>
          </Col>
        ...
        <div>
          <Spin spinning={this.state.loading}>
            {this.state.pricing.id ?
              <Form layout="vertical" onFinish={this.handleSubmit} initialValues={this.state.pricing}>
                <Row gutter={24}>
                  ...
                  <Col xs={24} sm={24} md={6} lg={6} xl={6}>
                    ...
                    >
                      <Switch
                        ...
                        defaultChecked={this.state.pricing.is_walkin_price == 1}
                      />
                    </Form.Item>
                  </Col>
                  <Col xs={24} sm={24} md={6} lg={6} xl={6}>
                    ...
                    >
                      <Switch
                        checkedChildren={"Active"}
                        unCheckedChildren={"Inactive"}
                        defaultChecked={this.state.pricing.status == 1}
                      />
                    </Form.Item>
                  </Col>
                </Row>
