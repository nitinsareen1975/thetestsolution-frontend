...
class ManageTestTypeMethods extends Component {
  constructor(props) {
    super(props);
    this.module = 'test_type_methods';
    this.state = {
      dataLoaded: false,
      loading: false,
      data: [],
        ...
        render: (_text, record) => (
          <span>
            <Tooltip title="Edit Definition">
              <Button
                onClick={() => this.props.history.push("./test-type-methods/edit/" + record.id)}
              >
                <EditOutlined />
              </Button>
            </Tooltip>
      ...
      <div className="gray-bg">
        <Row gutter={24}>
          ...
          <Col xs={12} sm={12} md={12} lg={12} xl={12}>
            <Button
              type="primary"
              onClick={() => this.props.history.push("./test-type-methods/add")}
