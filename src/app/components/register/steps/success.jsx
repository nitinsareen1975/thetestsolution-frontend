...
const output = ({...props}) => {
	...
	html.push(<Button type="link" onClick={() => resendEmail()}>Click Here</Button>);
	html.push(".");
	return <Spin spinning={submitting}>
		<Result
			...
			subTitle={html}
			extra={[
				<Button style={{ padding: "0 4px" }} onClick={() => window.location = Config.WEB_URL} type="primary" key="homebtn">
					Go to Homepage
				</Button>
			]}
		/>
